const SESSIONS = {
  ...
  '김태준': {
    'description': '꽤 오랜 기간동안 프로젝트에 RxSwift를 도입하려 했지만, 바로 시작하기에는 공부해야할 내용들이 많았습니다. 제가 RxSwift, RxCocoa를 이용해 개발을 시작할 때 느꼈던 어려움과 모호함. 그리고 그것들을 ReactorKit으로 극복한 경험을 공유합니다. 과거의 저처럼 RxSwift를 시작하고 싶은데, 주저하고 계시는 분들께 ReactorKit이란 선택지를 드립니다.',
  },
  '노수진': {
