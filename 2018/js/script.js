const SESSIONS = {
  '김은영': {
    'description': 'iOS 개발에서 외부 라이브러리를 사용한다면, Cocoapods 설치부터 이미 루비를 사용됩니다. 서버 개발에서 Ruby 가 활발하게 사용되는 일본에서는 iOS 개발 과정에서도 Ruby가 다양하게 활용되어 있습니다. 개발 이 조금 더 편리해지는 Ruby Gem들을 소개합니다.',
  },
  '김남현': {
